...
public:
	db_Table_Client(const bool& statusCreateDB, mySQL_db& connect, char mode);
...
public:
	...
	db_Table_hPassword(const bool& statusCreateDB, mySQL_db& connect, char mode);
...
public:
	...
	db_Table_Messages(const bool& statusCreateDB, mySQL_db& connect, char mode);
